...
class StartupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create startup" do
    assert_difference("Startup.count") do
      post startups_url, params: { startup: { description: @startup.description, name: @startup.name, user_id: @startup.user_id } }
    end
  ...
  test "should update startup" do
    patch startup_url(@startup), params: { startup: { description: @startup.description, name: @startup.name, user_id: @startup.user_id } }
